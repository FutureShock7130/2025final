...
public class Grabber extends SubsystemBase {
    ...
    public void setPosition(double position) {
        ...
        set(MathUtil.clamp(pidController.calculate(grabberEncoder.getAbsolutePosition().getValueAsDouble()), -0.2,
                0.2));
    }
    ...
    public void set(double output) {
        ...
        double totalVoltage = (MathUtil.clamp(output, -1, 1) * 12.0) + ffVolts;
