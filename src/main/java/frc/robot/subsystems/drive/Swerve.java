  ...
  public Swerve(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.119141)); // MUST BE CALIBRATED
        break;
      case 1:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(0.470215)); // MUST BE CALIBRATED
        break;
      case 2:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.291260)); // MUST BE CALIBRATED
        break;
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.036621 + 0.5)); // MUST BE CALIBRATED
        break;
      default:
