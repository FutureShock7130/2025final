  ...
  public Swerve(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(-0.117676)); // MUST BE CALIBRATED
        break;
      case 1:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(0.476074)); // MUST BE CALIBRATED
        break;
      case 2:
      ...
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(Units.rotationsToRadians(0.458008)); // MUST BE CALIBRATED
        break;
      default:
