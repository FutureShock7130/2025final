...
public class Drive extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (visionPose != null) {
            ...
            // SmartDashboard.putNumber("Odometry/Rotation (deg)",
            ...
            // SmartDashboard.putNumber("Robot Speed/Rotation (rad/s)",
    ...
    public ChassisSpeeds getRobotRelativeSpeeds() {
        ChassisSpeeds chassisSpeeds = ChassisSpeeds
                .fromFieldRelativeSpeeds(kinematics.toChassisSpeeds(getModuleStates()), getRotation());
